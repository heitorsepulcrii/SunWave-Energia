...
*   **Economia Real:** Foco na redução tarifária de até 95%.
...
```bash
git clone https://github.com/heitorsepulcrii/SunWave-Energia.git 
Starting
...
--------------------------------------------------------------------------------
📍 Rotas de Aplicação
A aplicação é estruturada em uma única página (SPA-style) com as seguintes seções principais:
Seção
Descrição
Sobre
Apresentação institucional e missão da SunWave.
Benefícios
Vantagens como valorização do imóvel e baixa manutenção.
Orçamento
Formulário de captura de leads via main.js.
Depoimentos
Seção de validação com feedback de clientes.
...
--------------------------------------------------------------------------------
📫 Contribua
1. git clone https://github.com/heitorsepulcrii/SunWave-Energia.git
2. git checkout -b feature/sua-melhoria
3. Siga os padrões de commit.
4. Abra um Pull Request detalhando as alterações no main.css ou na lógica do main.js.

--------------------------------------------------------------------------------
            © 2025 SunWave Energia — Todos os direitos reservados.
